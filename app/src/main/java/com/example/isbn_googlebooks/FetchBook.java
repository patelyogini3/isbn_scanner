package com.example.isbn_googlebooks;
...
public class FetchBook extends AsyncTask<String,Void,String>{
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            final String BOOK_BASE_URL =  "https://www.googleapis.com/books/v1/volumes?q=isbn:"+(input);
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            // If both are found, display the result on sysout
            if (title != null && authors != null){
                System.out.println(title+"\n"+authors+"\n"+description);
            } else {
                // If none are found, update the UI to show failed results.
                System.out.println(R.string.no_results);
            }
